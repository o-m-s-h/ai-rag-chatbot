...
export default function ChatLayout({ setModalOpen, messages, loading, bottomRef, fileInputRef, handleUpload, message, setMessage, handleSendMessage, modalOpen, handleCreateChat, uploading, uploadFileName }) {
    ...
    return <div className="chat-shell">
        <Sidebar onNewChat={() => setModalOpen(true)} mobileOpen={mobileOpen} onMobileClose={() => setMobileOpen(false)} />
